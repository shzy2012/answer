...
require (
	...
	github.com/answerdev/plugins/connector/github v0.0.0-20230803065424-608f46a7b4a7
	...
	github.com/segmentfault/pacman/contrib/i18n v0.0.0-20230615035753-123b178d46c5
